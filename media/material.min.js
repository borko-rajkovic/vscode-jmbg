...
!(function () {
  ...
  function t(e, t, s, i) {
    ...
    e.addEventListener('click', function (n) {
      ...
      i.resetTabState_(t),
        ...
        l.classList.add(i.CssClasses_.IS_ACTIVE);
    });
  }
  var s = {
  ...
  (s = (function () {
    function e(e, t) {
      for (var s = 0; s < p.length; s++)
        if (p[s].className === e)
          return 'undefined' != typeof t && (p[s] = t), p[s];
      return !1;
    }
    function t(e) {
    ...
    function i(t, s) {
      if ('undefined' == typeof t && 'undefined' == typeof s)
        ...
        for (
          var r = document.querySelectorAll('.' + s), d = 0;
          d < r.length;
          d++
        )
          n(r[d], l);
    ...
    function a(e) {
      Array.isArray(e) ||
        (e = 'function' == typeof e.item ? Array.prototype.slice.call(e) : [e]);
      for (var t, s = 0, i = e.length; i > s; s++)
        (t = e[s]),
  ...
  (window.MaterialButton = o),
    ...
    (o.prototype.mdlDowngrade_ = function () {
      this.rippleElement_ &&
        this.rippleElement_.removeEventListener(
          'mouseup',
          this.boundRippleBlurHandler
        ),
    ...
    (o.prototype.mdlDowngrade = o.prototype.mdlDowngrade_),
    (o.prototype.mdlDowngrade = o.prototype.mdlDowngrade),
    s.register({
      constructor: o,
  ...
  (window.MaterialCheckbox = r),
    ...
    (r.prototype.mdlDowngrade_ = function () {
      this.rippleContainerElement_ &&
        ...
        this.inputElement_.removeEventListener(
          'change',
          this.boundInputOnChange
        ),
    ...
    (r.prototype.mdlDowngrade = r.prototype.mdlDowngrade_),
    (r.prototype.mdlDowngrade = r.prototype.mdlDowngrade),
    s.register({
      constructor: r,
  ...
  (window.MaterialIconToggle = d),
    (d.prototype.Constant_ = { TINY_TIMEOUT: 0.001 }),
    ...
    (d.prototype.checkToggleState = d.prototype.checkToggleState),
    (d.prototype.checkDisabled = function () {
      this.inputElement_.disabled
        ? this.element_.classList.add(this.CssClasses_.IS_DISABLED)
        : this.element_.classList.remove(this.CssClasses_.IS_DISABLED);
    }),
    (d.prototype.checkDisabled = d.prototype.checkDisabled),
    ...
    (d.prototype.check = d.prototype.check),
    (d.prototype.uncheck = function () {
      (this.inputElement_.checked = !1), this.updateClasses_();
    }),
    (d.prototype.uncheck = d.prototype.uncheck),
    ...
    (d.prototype.mdlDowngrade = d.prototype.mdlDowngrade_),
    (d.prototype.mdlDowngrade = d.prototype.mdlDowngrade),
    s.register({
      constructor: d,
  ...
  (window.MaterialMenu = _),
    ...
    (_.prototype.addAnimationEndListener_ = function () {
      var e = function () {
        this.element_.removeEventListener('transitionend', e),
          this.element_.removeEventListener('webkitTransitionEnd', e),
          this.element_.classList.remove(this.CssClasses_.IS_ANIMATING);
      }.bind(this);
      this.element_.addEventListener('transitionend', e),
        this.element_.addEventListener('webkitTransitionEnd', e);
    }),
    ...
    (_.prototype.show = _.prototype.show),
    (_.prototype.hide = function () {
      if (this.element_ && this.container_ && this.outline_) {
        for (
          ...
          e[t].style.transitionDelay = null;
    ...
    (_.prototype.hide = _.prototype.hide),
    (_.prototype.toggle = function (e) {
      this.container_.classList.contains(this.CssClasses_.IS_VISIBLE)
        ? this.hide()
        : this.show(e);
    }),
    (_.prototype.toggle = _.prototype.toggle),
    (_.prototype.mdlDowngrade_ = function () {
      for (
        ...
        e[t].removeEventListener('click', this.boundItemClick_),
          e[t].removeEventListener('keydown', this.boundItemKeydown_);
    }),
    (_.prototype.mdlDowngrade = _.prototype.mdlDowngrade_),
    (_.prototype.mdlDowngrade = _.prototype.mdlDowngrade),
    s.register({
      constructor: _,
  ...
  (window.MaterialProgress = h),
    ...
    (h.prototype.mdlDowngrade = h.prototype.mdlDowngrade_),
    (h.prototype.mdlDowngrade = h.prototype.mdlDowngrade),
    s.register({
      constructor: h,
  ...
  (window.MaterialRadio = p),
    (p.prototype.Constant_ = { TINY_TIMEOUT: 0.001 }),
    ...
    (p.prototype.checkDisabled = p.prototype.checkDisabled),
    (p.prototype.checkToggleState = function () {
      this.btnElement_.checked
        ? this.element_.classList.add(this.CssClasses_.IS_CHECKED)
        : this.element_.classList.remove(this.CssClasses_.IS_CHECKED);
    }),
    (p.prototype.checkToggleState = p.prototype.checkToggleState),
    ...
    (p.prototype.check = p.prototype.check),
    (p.prototype.uncheck = function () {
      (this.btnElement_.checked = !1), this.updateClasses_();
    }),
    (p.prototype.uncheck = p.prototype.uncheck),
    ...
    (p.prototype.mdlDowngrade_ = function () {
      ...
      this.btnElement_.removeEventListener('change', this.boundChangeHandler_),
        ...
        e &&
          (e.removeEventListener('mouseup', this.boundMouseUpHandler_),
          this.element_.removeChild(e));
    }),
    (p.prototype.mdlDowngrade = p.prototype.mdlDowngrade_),
    (p.prototype.mdlDowngrade = p.prototype.mdlDowngrade),
    s.register({
      constructor: p,
  ...
  (window.MaterialSlider = c),
    ...
    (c.prototype.change = c.prototype.change),
    ...
    (c.prototype.mdlDowngrade_ = function () {
      this.element_.removeEventListener('input', this.boundInputHandler),
        ...
        this.element_.parentElement.removeEventListener(
          'mousedown',
          this.boundContainerMouseDownHandler
        );
    }),
    (c.prototype.mdlDowngrade = c.prototype.mdlDowngrade_),
    (c.prototype.mdlDowngrade = c.prototype.mdlDowngrade),
    s.register({
      constructor: c,
  ...
  (window.MaterialSwitch = C),
    ...
    (C.prototype.on = C.prototype.on),
    (C.prototype.off = function () {
      (this.inputElement_.checked = !1), this.updateClasses_();
    }),
    (C.prototype.off = C.prototype.off),
    (C.prototype.init = function () {
      if (this.element_) {
        this.inputElement_ = this.element_.querySelector(
          '.' + this.CssClasses_.INPUT
  ...
  (window.MaterialTextfield = E),
    ...
    (E.prototype.checkDirty = E.prototype.checkDirty),
    ...
    (E.prototype.change = E.prototype.change),
  ...
  (window.MaterialTooltip = L),
    (L.prototype.Constant_ = {}),
    (L.prototype.CssClasses_ = { IS_ACTIVE: 'is-active' }),
    (L.prototype.handleMouseEnter_ = function (e) {
      ...
      0 > s + i
        ...
        : ((this.element_.style.left = s + 'px'),
          (this.element_.style.marginLeft = i + 'px')),
        (this.element_.style.top = t.top + t.height + 10 + 'px'),
        this.element_.classList.add(this.CssClasses_.IS_ACTIVE),
        window.addEventListener('scroll', this.boundMouseLeaveHandler, !1),
        window.addEventListener('touchmove', this.boundMouseLeaveHandler, !1);
    }),
    ...
    (L.prototype.mdlDowngrade_ = function () {
      this.forElement_ &&
        (this.forElement_.removeEventListener(
          'mouseenter',
          this.boundMouseEnterHandler,
          !1
        ),
    ...
    (L.prototype.mdlDowngrade = L.prototype.mdlDowngrade_),
    (L.prototype.mdlDowngrade = L.prototype.mdlDowngrade),
    s.register({
      constructor: L,
  ...
  (window.MaterialLayout = I),
    ...
    (I.prototype.Mode_ = { STANDARD: 0, SEAMED: 1, WATERFALL: 2, SCROLL: 3 }),
    ...
    (I.prototype.init = function () {
      if (this.element_) {
        ...
        e.classList.add(this.CssClasses_.CONTAINER),
          ...
          e.appendChild(this.element_);
        for (
          var s = this.element_.childNodes, i = s.length, n = 0;
          i > n;
          n++
        ) {
          var a = s[n];
        ...
        if (
          (this.header_ &&
            ...
            l === this.Mode_.STANDARD
              ? (this.header_.classList.add(this.CssClasses_.CASTING_SHADOW),
                this.tabBar_ &&
                  this.tabBar_.classList.add(this.CssClasses_.CASTING_SHADOW))
              : l === this.Mode_.SEAMED || l === this.Mode_.SCROLL
              ? (this.header_.classList.remove(this.CssClasses_.CASTING_SHADOW),
                this.tabBar_ &&
          ...
          var o = this.element_.querySelector(
            '.' + this.CssClasses_.DRAWER_BTN
          );
          if (!o) {
            (o = document.createElement('div')),
              o.classList.add(this.CssClasses_.DRAWER_BTN);
            var r = document.createElement('i');
            r.classList.add(this.CssClasses_.ICON),
              (r.textContent = this.Constant_.MENU_ICON),
              o.appendChild(r);
          }
          this.drawer_.classList.contains(this.CssClasses_.ON_LARGE_SCREEN)
            ? o.classList.add(this.CssClasses_.ON_LARGE_SCREEN)
            : this.drawer_.classList.contains(
                this.CssClasses_.ON_SMALL_SCREEN
              ) && o.classList.add(this.CssClasses_.ON_SMALL_SCREEN),
            o.addEventListener('click', this.drawerToggleHandler_.bind(this)),
            this.element_.classList.add(this.CssClasses_.HAS_DRAWER),
            this.element_.classList.contains(this.CssClasses_.FIXED_HEADER)
              ? this.header_.insertBefore(o, this.header_.firstChild)
              : this.element_.insertBefore(o, this.content_);
        ...
        if (
          ...
          _.classList.add(this.CssClasses_.TAB_CONTAINER),
            this.header_.insertBefore(_, this.tabBar_),
            this.header_.removeChild(this.tabBar_);
          var h = document.createElement('div');
          h.classList.add(this.CssClasses_.TAB_BAR_BUTTON),
            h.classList.add(this.CssClasses_.TAB_BAR_LEFT_BUTTON);
          ...
          u.classList.add(this.CssClasses_.ICON),
            ...
            _.appendChild(h),
            _.appendChild(this.tabBar_),
            _.appendChild(c);
          var C = function () {
            this.tabBar_.scrollLeft > 0
              ? h.classList.add(this.CssClasses_.IS_ACTIVE)
          ...
          this.tabBar_.addEventListener('scroll', C),
            C(),
          ...
          for (
            var m = this.tabBar_.querySelectorAll('.' + this.CssClasses_.TAB),
  ...
  (window.MaterialDataTable = f),
    ...
    (f.prototype.createCheckbox_ = function (e, t) {
      ...
      return (
        ...
        a.addEventListener('change', this.selectRow_(a, e, t)),
        i.appendChild(a),
  ...
  (window.MaterialRipple = b),
    ...
    (b.prototype.mdlDowngrade = b.prototype.mdlDowngrade_),
    (b.prototype.mdlDowngrade = b.prototype.mdlDowngrade),
    s.register({
      constructor: b,
